...
class TestConfig(unittest.TestCase):
    ...
    def test_config(self):
        ...
        self.assertEqual(pc_s, '2018-01-31TrueFalseBiffPredictor5111100Close2018-01-0110')
        ...
        self.assertEqual(pc_csv[0], u'end_date,normalize,normalize_by_row,predictor_cls,'
                                    ...
                                    u'predictor_params.starting_investment,price_column,start_date,window_size')
        self.assertEqual(pc_csv[1], '2018-01-31,True,False,BiffPredictor,5,1,1,1,100,Close,2018-01-01,10')
