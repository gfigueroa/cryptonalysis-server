...
class TestConfig(unittest.TestCase):
    ...
    def test_config(self):
        ...
        self.assertEqual(pc_s, '2019-02-28TrueFalseBiffPredictor5111100CloseFalse2019-01-0110')
        ...
        self.assertEqual(pc_csv[0], u'end_date,normalize,normalize_by_row,predictor_cls,'
                                    ...
                                    u'window_size')
        self.assertEqual(pc_csv[1], '2019-02-28,True,False,BiffPredictor,5,1,1,1,100,Close,False,2019-01-01,10')
    ...
    def test_config_dl(self):
        ...
        self.assertEqual(dlc_csv[0], u'activation_function,neurons')
        self.assertEqual(dlc_csv[1], 'sigmoid,10')
